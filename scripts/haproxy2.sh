MASTER0IP=172.90.0.103
MASTER1IP=172.90.0.104
MASTER2IP=172.90.0.105
...
priority 101
unicast_src_ip $MASTER2IP ## Master-01 IP Address
unicast_peer {
$MASTER0IP ## Enter Master-02 IP Address
$MASTER1IP ## Enter Master-03 IP Address
}
virtual_ipaddress {
